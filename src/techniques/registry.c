...
TechniqueFn techniques[] = {
    ...
    pointing_set,  x_wing,           y_wing,           swordfish,
    skyscraper,    simple_coloring,  jellyfish,        medusa,
    finned_x_wing, finned_swordfish, finned_jellyfish,
};
